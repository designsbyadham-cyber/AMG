  ...
  if (error || !broadcast) {
    return (
      <div className="flex h-64 flex-col items-center justify-center gap-2">
        <p className="text-sm text-danger">{error ?? 'Broadcast not found'}</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        {/* Delete — inline-confirm pattern matches the pipeline-settings
            ...
            funnel inconsistent. */}
        {confirmDelete ? (
          <div className="flex items-center gap-2 rounded-md border border-danger/30 bg-danger-soft px-3 py-1.5 text-sm">
            <span className="text-danger">Delete this broadcast?</span>
            <Button
              variant="outline"
              size="sm"
          ...
          <Button
            ...
            className="border-danger/30 bg-transparent text-danger hover:bg-danger-soft disabled:opacity-40"
          >
