...
> = {
  ...
  viewer: {
    ...
    className:
      "border-sidebar-border bg-sidebar-accent/50 text-sidebar-foreground/45",
  },
};
import {
  Avatar,
      ...
      >
        ...
        <div className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-sidebar-border px-4">
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <img src="/logo.png" alt="Automillennium Group" className="h-7 w-auto" />
          </Link>
          <button
            type="button"
            onClick={onClose}
                  ...
                  >
                    ...
                    {item.beta && (
                      <span
                        ...
                        className="rounded-full border border-warning/40 bg-warning-soft px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wider text-warning"
                      >
                        Beta
                      </span>
                    )}
        ...
        <div className="shrink-0 border-t border-sidebar-border p-3">
          ...
          {showAccountStrip && account?.name ? (
            <div className="mb-2 flex items-center gap-2 px-3 text-xs text-sidebar-foreground/45">
